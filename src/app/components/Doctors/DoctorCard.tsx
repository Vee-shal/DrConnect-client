...
src={imageUrl || "/Assets/banner2.webp"}
    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-2">
        <span className="px-2 py-1 bg-[#1ebc8b]/10 text-[#1ebc8b] text-xs rounded-full">{specialization}</span>
      ...
      {clinicName && (
        <div className="flex items-start gap-2 text-sm">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="#1ebc8b">
